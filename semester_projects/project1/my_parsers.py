...
def Asos(request, type_sort=None, gender=None,size=None, num_pages=5):
...
def Rozetka(request, type_sort=None, gender=None,size=None, num_pages=5):
    """
    :param request: str, example "adidas yung"
    ...
    all_info = find_links_rozetka(new_url, num_pages)
...
def Lamoda(request, type_sort=None, gender=None,size=None, num_pages=5):
    ...
    all_info = find_links_lamoda(html, num_pages)
...
if __name__ == "__main__":
    ...
    print(Lamoda("adidas stan smith","cheap","man", '44', "man"))
    print(Asos("adidas stan smith","cheap", '44', "man"))
    print(Amazon("adidas stan smith","cheap", '44', "man"))
    print(Rozetka("adidas stan smith","cheap", '44', "man"))
